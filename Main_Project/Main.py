...
from Application.view.login_dialog import LoginDialog
...
def main():
    ...
    # Cria as instâncias dos controladores
    video_controller = VideoController()
    data_controller = DataController()
    user_controller = UserController()

    # Inicializa a janela de login
    login = LoginDialog(user_controller)
    ...
    if login.exec():
        ...
        window = MainWindow(user_controller, video_controller, data_controller, classes)
        window.show()
        sys.exit(app.exec())
